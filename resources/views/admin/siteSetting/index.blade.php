          ...
          <div class="card">
            <div class="card-body">
              <ul class="nav nav-pills flex-column">
                <li class="nav-item"><a href="#" class="nav-link" id="general-tab">General</a></li>
                <li class="nav-item"><a href="#" class="nav-link" id="email-setup-tab">Email Setup</a></li>
              </ul>
            </div>
          </div>
        </div>
            ...
            <form id="general-settings-form" method="POST" enctype="multipart/form-data">
              ...
              <div class="card" id="settings-card">
                ...
                <div class="card-body">
                  ...
                  <!-- Address -->
                  <div class="form-group row align-items-center">
                    <label for="address" class="form-control-label col-sm-3 text-md-right">Site Address</label>
                    <div class="col-sm-6 col-md-9">
                  ...
                  <div class="form-group row align-items-center">
                    ...
                    <div class="col-sm-6 col-md-9">
                      ...
                      <div class="form-text text-muted">
                        <img width="60px" src="{{ asset($siteSetting->site_logo ?? '') }}" class="img-responsive img-fluid" alt="logo"><br>
                  ...
                  <div class="form-group row align-items-center">
                    ...
                    <div class="col-sm-6 col-md-9">
                      ...
                      <div class="form-text text-muted">
                        <img width="60px" src="{{ asset($siteSetting->site_favicon ?? '') }}" class="img-responsive img-fluid" alt="favicon"><br>
                        The image must have a maximum size of 1MB
                      </div>
                      @error('site_favicon')
                      <span class="text-danger">{{ $message }}</span>
                ...
                <div class="card-footer bg-whitesmoke text-md-right">
                  <button class="btn btn-primary" type="button" id="general-save-btn">Save Changes</button>
          ...
          <div id="email-setup-form" class="{{ request('tab') !== 'email-setup' ? 'hidden' : '' }}">
            <form id="email-settings-form" method="POST">
              ...
              <div class="card" id="settings-card">
                ...
                <div class="card-footer bg-whitesmoke text-md-right">
                  <button class="btn btn-primary" type="button" id="email-save-btn">Save Changes</button>
                  <button class="btn btn-secondary" type="button">Reset</button>
                </div>
              </div>
            </form>
