...
<head>
  ...
  <link rel="shortcut icon" href="{{ asset($user->student->passport_photo) }}" type="image/x-icon">
</head>
<body>
                    ...
                    {{-- @dd($user) --}}
                        <div class="container">
                            <div class="mt-5 shadow card">
                                <div class="p-3 text-center img-responsive">
                                    <img src="{{ asset($user->student->passport_photo) }}" alt="Passport Photo" class="img-fluid" width="120px">
                                </div>
                            <ul class="list-group">
