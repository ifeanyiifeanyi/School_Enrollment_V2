                ...
                <div class="document">
                    ...
                    <div class="student-info">
                        <div>
                            ...
                            <p><strong>Department:</strong> {{ auth()->user()->applications->first()->department->name ?? 'N/A' }}</p>
                    ...
                    @if ($application == 'under_review' || $application == 'pending')
                        <p>We have received your scholarship application for the academic year 2024-2025. Our team is
                            currently reviewing your application and supporting documents.</p>
                    @elseif($application == 'approved')
                        <p>Congratulations! We are pleased to inform you that your scholarship application for the academic
                    ...
                    @elseif($application == 'denied')
                        <p>Thank you for your scholarship application for the academic year 2024-2025. After careful
                            consideration, we regret to inform you that your application has not been approved at this time.
                        </p>
                    @endif
                    @if ($application->status == 'pending')
                        <div class="notice">
                    ...
                    @if ($application->status == 'under_review' || $application->status == 'pending')
                        <p>The status of your application will be communicated via your registered email address. We
                            strongly recommend that you regularly log in to your student dashboard to check for any updates
                            or additional requirements.</p>
                    @elseif($application->status == 'approved')
                        <p style="color: rgb(3, 165, 165)">Congratulations on your outstanding achievement! We are thrilled
                            to inform you that your scholarship application has been successfully received. This scholarship
                            covers your tuition fees, ensuring that you can focus entirely on your studies without financial
                            concerns. </p>

                        <p> We highly recommend printing a copy of this acceptance offer for your records. We are proud of
                            your accomplishments and look forward to supporting your academic journey. Keep up the excellent
                            work and continue striving for excellence. Congratulations once again on this remarkable
                            milestone!</p>
                    @elseif($application->status == 'denied')
                        <p>If you have any questions about the decision or would like feedback on your application, please
                            don't hesitate to contact the Scholarship Office. We encourage you to explore other financial
                            aid options and wish you the best in your academic pursuits.</p>
                    @endif

                    <p>If you have any questions or need to provide additional information, please don't hesitate to contact
                    ...
                    @if ($application->status == 'approved')
                        <div class="text-center print-button no-print">
                            <button onclick="window.print()" class="btn btn-primary">Print Scholarship Approval</button>
                        </div>
                    @endif
                </div>
            </div>
